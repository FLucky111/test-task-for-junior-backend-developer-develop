...
func main() {
	...
	taskTemplateRepo := postgresrepo.NewTaskTemplateRepository(pool)
	taskTemplateService := tasktemplateusecase.NewService(taskTemplateRepo)
	taskTemplateHandler := httphandlers.NewTaskTemplateHandler(taskTemplateService)
